...
static void MX_I2C1_SMBUS_Init(void)
{
  ...
  hsmbus1.Init.SMBusTimeout = 0x00008019;
...
static void MX_I2C2_SMBUS_Init(void)
{
  ...
  hsmbus2.Init.SMBusTimeout = 0x00008019;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_8
  ...
  /*Configure GPIO pins : PB2 UCPD_DBN_Pin LED_BLUE_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_2|UCPD_DBN_Pin|LED_BLUE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
